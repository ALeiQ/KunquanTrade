...
public class BankInfoExample {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public BankInfoExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public BankInfoExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public BankInfoExample page(Integer page, Integer pageSize) {
