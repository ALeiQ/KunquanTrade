...
public class CompanyInfoExample {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public CompanyInfoExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public CompanyInfoExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public CompanyInfoExample page(Integer page, Integer pageSize) {
