...
public class TransportDetailsExample {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public TransportDetailsExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public TransportDetailsExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public TransportDetailsExample page(Integer page, Integer pageSize) {
