...
public class GoodsInfoExample {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public GoodsInfoExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public GoodsInfoExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public GoodsInfoExample page(Integer page, Integer pageSize) {
