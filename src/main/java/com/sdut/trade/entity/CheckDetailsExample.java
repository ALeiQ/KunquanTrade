...
public class CheckDetailsExample {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public CheckDetailsExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public CheckDetailsExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public CheckDetailsExample page(Integer page, Integer pageSize) {
